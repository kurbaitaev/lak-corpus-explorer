...
(function () {
  ...
  var DICT = {
    ...
    /* ── lemmas.html ───────────────────────────────────────── */
    'lemmas.meta.title': { en: 'Lak dictionary · Lak Corpus Explorer', ru: 'Лакский словарь · Корпус лакского языка' },
    'lemmas.h1': { en: 'Lak dictionary', ru: 'Лакский словарь' },
    'lemmas.intro': {
      en: 'Search Lak or Russian. Open each lemma to inspect meanings, forms, sources, and corpus occurrences.',
      ru: 'Ищите на лакском или русском. Откройте лемму, чтобы увидеть значения, формы, источники и вхождения в корпусе.'
    },
    'lemmas.searchLabel': { en: 'Search the dictionary', ru: 'Поиск по словарю' },
    'lemmas.searchPlaceholder': { en: 'Lak or Russian word', ru: 'Слово на лакском или русском' },
    'lemmas.total': { en: '{count} lemmas', ru: '{count} лемм' },
    'lemmas.matches': { en: '{count} dictionary entries', ru: '{count} словарных статей' },
    'lemmas.match': { en: 'Matched {term}', ru: 'Совпадение: {term}' },
    ...
    'lemmas.sources': { en: '{count} sources', ru: '{count} источников' },
    ...
    'lemmas.sourceEvidence': { en: 'Source-backed lemma', ru: 'Лемма подтверждена источником' },
    'lemmas.entries': { en: 'Dictionary evidence', ru: 'Словарные свидетельства' },
    'lemmas.fullEntry': { en: 'Full source entry', ru: 'Полная словарная статья' },
