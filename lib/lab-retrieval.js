...
// Evidence classes. Only the first two may ever supply a suggested target:
...
//   validated_parallel — a human-approved parallel pair (reserved for future
//                        wiring; current corpus rows are NOT validated parallel).
//   corpus_example     — attested monolingual usage. NEVER a translation.
const TRANSLATION_EVIDENCE = new Set(['dictionary_sense', 'alias', 'validated_parallel']);
